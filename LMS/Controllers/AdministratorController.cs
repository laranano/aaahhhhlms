    ...
    public class AdministratorController : Controller
    {
        ...
        public IActionResult GetCourses(string subject)
        {
            var query = from c in db.Courses
                        where c.CourseDeptAbbreviation == subject
                        select new
                        {
                            number = c.CourseNum,
                            name = c.Name
        ...
        public IActionResult GetProfessors(string subject)
        {
            var query = from p in db.Professors
                        where p.WorkDeptAbbreviation == subject
                        select new
                        {
                            lname = p.LastName,
                            fname = p.FirstName,
        ...
        public IActionResult CreateCourse(string subject, int number, string name)
        {
            try
            {
                ...
                {
                    CourseDeptAbbreviation = subject,
    ...
    DateTime start, DateTime end, string location, string instructor)
        {
            ...
            var timeConflict = db.Classes.Any(c =>
                c.Location == location &&
                c.Season == season &&
                c.Year == (ushort)year &&
            ...
            var duplicateClass = db.Classes.Any(c =>
                c.CourseDeptAbbreviation == subject &&
